...
Therefore, writing documentation is usually something programmers try to avoid.
...
===== History
The idea to generate diagrams from source code is not new, but has a long history in software development,
...
diagrams and sometimes even provide full Roundtrip-Engineering capabilities. However, they are usually very
expensive, have a significant learning curve and force the development team to fully buy into their proprietary way of
working.
...
include::doc/under-construction.adoc[]
...
ifndef::env-github[]
plantuml::annotation-processors/doc/annotation-processor_class.puml[]
endif::[]
